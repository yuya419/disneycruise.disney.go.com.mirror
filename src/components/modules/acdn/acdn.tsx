  ...
  return (
    <div className={`acdn ${isOpen ? "isOpen" : ""}`}>
      ...
      <div className="acdn-content" data-hidden={!isOpen}>
        <div className="acdn-inner">{content}</div>
      </div>
    </div>
  );
}
...
export { AccordionType01, AccordionType02, AccordionType03 };
