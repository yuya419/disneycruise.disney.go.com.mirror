    ...
    return (
        <dl className="form-input-box">
            ...
            <dd className="form-input-content">
                <div className="input">
                    <label className="form-input-label is-label-code">〒<input type="text" name={"code-" + name} placeholder="郵便番号" required={required} /></label>
                    <label className="form-input-label is-label-prefectures">
                        <select name={"prefectures-" + name} required={required}>
                ...
                <div className="input">
                    <label className="form-input-label is-label-city">
                        ...
                        <input type="text" name={"city-" + name} placeholder="市区町村を入力してください" required={required} />
                    </label>
                </div>
                <div className="input">
                    <label className="form-input-label is-label-street">
                        <span className="ttl">番地</span>
                        <input type="text" name={"street-" + name} placeholder="番地を入力してください" required={required} />
                    </label>
                </div>
                <div className="input">
                    <label className="form-input-label is-label-building">
                        <span className="ttl">建物名・部屋番号</span>
                        <input type="text" name={"building-" + name} placeholder="建物名・部屋番号を入力してください" />
                    </label>
                </div>
            </dd>
        </dl>
