...
import {
  AccordionType01,
  AccordionType02,
} from "@/components/modules/acdn/acdn";
        ...
        const observer = new IntersectionObserver(
          ([entry]) => {
            if (entry.isIntersecting) {
              document.body.classList.remove("is-filter-button-show");
            } else {
              document.body.classList.add("is-filter-button-show");
            }
          },
            ...
            <ul className="nav-menu">
              <li className="menu-item">
                <a
                  ...
                  data-current={currentSection === "input01" ? "true" : "false"}
                >
                  コース情報の入力
                </a>
              </li>
              <li className="menu-item">
                <a
                  href="#input02"
                  className="menu-item-link"
                  data-current={currentSection === "input02" ? "true" : "false"}
                >
                  代表者様情報の入力
                </a>
              </li>
              <li className="menu-item">
                <a
                  href="#input03"
                  className="menu-item-link"
                  data-current={currentSection === "input03" ? "true" : "false"}
                >
                  お客様情報の入力
                </a>
              </li>
              <li className="menu-item">
                <a
                  href="#input04"
                  className="menu-item-link"
                  data-current={currentSection === "input04" ? "true" : "false"}
                >
                  利用規約・
                  <br />
                  プライバシーポリシー
              ...
              <li className="menu-item">
                <a
                  href="#input05"
                  className="menu-item-link"
                  data-current={currentSection === "input05" ? "true" : "false"}
                >
                  備考
                </a>
              </li>
      ...
      return (
        <div className="l-aside-form">
          ...
          <ol className="step-list">
            <li
              className="step-item"
              data-current={step === "input" ? "true" : "false"}
            >
            ...
            <li
              className="step-item"
              data-current={step === "confirm" ? "true" : "false"}
            >
              <span className="mark"></span>
            ...
            <li
              className="step-item"
              data-current={step === "complete" ? "true" : "false"}
            >
              <span className="mark"></span>
    ...
    if (page === "page") {
      ...
      useEffect(() => {
        const toggleCurrent = (id: string) => {
          ...
          const currentItem = uListRef.current?.querySelector(
            `[data-anchor="${id}"]`,
          );
          if (currentItem) {
