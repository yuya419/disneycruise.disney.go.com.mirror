...
export default function Single() {
    ...
    // コース情報と検索クエリの初期化
    const post: { courses: course | null; schedule: schedule | null; searchQuery: SearchQuery | null; } = { courses: null, schedule: null, searchQuery: null }
            ...
            <section id="type" className="s-course-type">
                <div className="container">
                    <div className="s-course-type__head">
                        <Headline design="01" hlLevel="h2">客室タイプ</Headline>
            ...
            <section id="schedule" className="s-schedule-type">
                <div className="container">
                    <div className="s-schedule-type__head">
                        <Headline design="01" hlLevel="h2">スケジュール</Headline>
                    </div>
            ...
            <section id="notice" className="s-notice-type">
                <div className="container">
                    <div className="s-notice-type__head">
                        <Headline design="01" hlLevel="h2">注意事項</Headline>
                    </div>
                    <div className="s-notice-type__detail">
                        <div className="detail">
                            <ul>
                                <li>「子供」とは、出発日の時点で13歳未満の方を指します。</li>
                                <li>いずれの客室も最初の2名は、年齢に関係なく大人とみなされます。</li>
                                <li>表示されている客室料金は、予約を確実に確保するために必要な最終的な総額です。</li>
                                <li>ご予約が確定次第、ミキ・ツーリストのクルーズ運営チームが可能な限り速やかにディズニー公式確認書を送付いたします。通常1営業日以内の送付を目指しますが、手配状況により時間を要する場合がございます。</li>
                                <li>こちらのディズニー公式確認番号により、ディズニー・クルーズラインでの予約が確定したことが保証されます。</li>
                                <li>ご予約が確定した後も、お客様の個人情報（および同行者（いる場合））がディズニー クルーズ ラインのシステムに更新されるまでに、しばらく時間がかかる場合があります。ディズニー クルーズ ラインのオペレーション チームを通じて公式ディズニー確認書にお客様の詳細が更新されるまで、最大 (30) 営業日かかる場合があります。</li>
                                <li>情報の更新には時間がかかる場合があり、お客様の情報更新が完全に完了するまではディズニークルーズライン公式アプリ「ディズニークルーズラインナビゲーター」および「ディズニー・クルーズライン公式サイト」にログインすることができません。ご迷惑をおかけしますが、ご了承ください。</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <section className="s-cancel-type">
                <div className="container">
                    <div className="s-cancel-type__head">
                        <Headline design="01" hlLevel="h2">キャンセル料について</Headline>
                    </div>
