    ...
    return (
        <div className="l-delivery">
            <div className="l-delivery-detail">
                <div className="text">
                    <p>ミキ・ツーリストが取り扱うクルーズブランド<br className="nosp"/>（ディズニークルーズライン、ロイヤル・カリビアン・インターナショナル、セレブリティクルーズ）に関する<br className="nosp"/>最新情報やお得なキャンペーン情報をメールマガジンにて配信しています。</p>
                </div>
                <div className="delivery">
                    ...
                    <ul className="delivery-list">
                        <li className="list-item">クルーズ料金ディスカウント等の期間限定<br className="nopc"/>キャンペーン情報</li>
