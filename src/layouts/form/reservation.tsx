        ...
        <div className="l-reservation-detail__content">
          ...
          <div className="overview">
            ...
            <dl className="overview-item is-item-room">
              <Headline design="01" hlLevel="dt">
                客室タイプ
              </Headline>
              <dd>
                <span>
                  コンシェルジュロイヤルスイートオーシャンビューベランダ客室​
                </span>
              </dd>
            </dl>
            ...
            <dl className="overview-item is-item-price">
              ...
              <dd>
                <span className="total">
                  合計<span className="val">$ 1,054</span>
                </span>
                <span className="price">
                  大人
                  <span className="val">
                    $400<span className="cross"></span>2名,
                  </span>{" "}
                  子供
                  <span className="val">
                    $254<span className="cross"></span>1名
                  </span>
                </span>
              </dd>
            </dl>
