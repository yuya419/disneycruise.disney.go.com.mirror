...
export function Page() {
    ...
    const type01Array = [
        {
            id: `type01-01`,
            src: `page/accommodations/type01/img01.jpg`,
        ...
        {
            id: `type01-02`,
            src: `page/accommodations/type01/img02.jpg`,
        ...
        {
            id: `type01-03`,
            src: `page/accommodations/type01/img03.jpg`,
        ...
        {
            id: `type01-04`,
            src: `page/accommodations/type01/img04.jpg`,
        ...
        {
            id: `type01-05`,
            src: `page/accommodations/type01/img05.jpg`,
        ...
        {
            id: `type01-06`,
            src: `page/accommodations/type01/img06.jpg`,
            name: `コンシェルジュスイートオーシャンビュー<br />ベランダ客室`,
        ...
        {
            id: `type01-07`,
            src: `page/accommodations/type01/img07.jpg`,
        ...
        {
            id: `type01-08`,
            src: `page/accommodations/type01/img08.jpg`,
    ...
    const type02Array = [
        {
            id: `type02-01`,
            src: `page/accommodations/type02/img01.jpg`,
        ...
        {
            id: `type02-02`,
            src: `page/accommodations/type02/img02.jpg`,
        ...
        {
            id: `type02-03`,
            src: `page/accommodations/type02/img03.jpg`,
        ...
        {
            id: `type02-04`,
            src: `page/accommodations/type02/img04.jpg`,
            name: `ベランダ客室​`,
            caption: `Artist Concept Only &copy;Disney`,
    ...
    const type03Array = [
        {
            id: `type03-01`,
            src: `page/accommodations/type03/img01.jpg`,
        ...
        {
            id: `type03-02`,
            src: `page/accommodations/type03/img02.jpg`,
            name: `オーシャンビュー客室`,
            caption: `Artist Concept Only &copy;Disney`,
    ...
    const type04Array = [
        {
            id: `type04-01`,
            src: `page/accommodations/type04/img01.jpg`,
            name: `デラックス内側客室（リーフビュー付き）`,
            caption: `Artist Concept Only &copy;Disney`,
            desc: `冒険好きな友人同士の旅行に最適な、内側の客室は最大4名様まで宿泊可能です。楽しい太陽と冒険を満喫した1日を過ごした後は、ぐっすり眠ってエネルギーを回復するのに最適な場所です。`
        },
        {
            id: `type04-02`,
            src: `page/accommodations/type04/img02.jpg`,
            name: `デラックス内側客室`,
            caption: `Artist Concept Only &copy;Disney`,
        ...
        {
            id: `type04-03`,
            src: `page/accommodations/type04/img03.jpg`,
            name: `内側客室`,
            caption: `Artist Concept Only &copy;Disney`,
            ...
            <div className="room-modal-container">
                ...
                <div className="room-modal-inner">
                    <div className="room-outline">
                        {modalData[id].slider.some((slide: { src: string; caption: string }) => slide.src || slide.caption) &&
                            <div className="room-outline__slider">
                                <Slider type="small" slides={sliderItems} options={{ loop: true }} />
                            </div>}
                        <div className="room-outline__head">
                            {modalData[id].name &&
                                <p className="jp" dangerouslySetInnerHTML={{ __html: modalData[id].name }}></p>}
                            {modalData[id].en &&
                                <p className="en" lang="en" dangerouslySetInnerHTML={{ __html: modalData[id].en }}></p>}
                        </div>
                    </div>
                    {modalData[id].desc &&
                    ...
                    {modalData[id].cat.some((item: { cat: string; area: string }) => item.cat || item.area) &&
                        <div className="room-cat">
                            <table>
                                <thead><tr><th>客室<br className="nopc" />カテゴリー</th><th>エリア</th></tr></thead>
                                <tbody>
                                    {modalData[id].cat.map((item: { cat: string; area: string }, index: number) => (
                                        <tr key={index}>
                                            <td>{item.cat}</td>
                                            <td>{item.area}</td>
                                        </tr>
                    ...
                    {modalData[id].roomFacilities.cat.some((item: { name: string; list: string[] }) => item.name.trim() !== "" || item.list.length > 0) &&
                        <div className="room-facilities">
                            <div className="room-facilities__head">
                                <p>
                                    <span className="icon"><svg className="i-facilities"><use xlinkHref="#i-facilities" /></svg></span>
                                    <span className="label">客室設備</span>
                                </p>
                            </div>
                            <div className="room-facilities__body">
                                {modalData[id].roomFacilities.cat.map((item: { name: string; list: string[] }, index: number) => (
                                    <div className="room-facilities-item" key={index}>
                                        {item.name && <p className="name" dangerouslySetInnerHTML={{ __html: item.name }}></p>}
                                        <ul>
                                            {item.list.map((listItem, listIndex) => <li key={listIndex} dangerouslySetInnerHTML={{ __html: listItem }}></li>)}
                                        </ul>
                                    </div>
                                ))}
                            </div>
                    ...
                    {modalData[id].specification.some((spec: { dt: string; dd: string }) => spec.dt || spec.dd) &&
                        <div className="room-specification">
                            <div className="room-specification__head">
                                <Headline design="01" hlLevel="p">仕様</Headline>
                            </div>
                            <div className="room-specification__body">
                                {
                                    modalData[id].specification.map((spec: { dt: string; dd: string }, index: number) => (
                                        <dl key={index}>
                    ...
                    {modalData[id].amenities.length > 0 &&
                        <div className="room-amenities">
                            <div className="room-amenities__head">
                                <Headline design="01" hlLevel="p">アメニティ</Headline>
                            </div>
                            <div className="room-amenities__body">
                                <ul>
                                    {modalData[id].amenities.map((item: string, index: number) => <li key={index} dangerouslySetInnerHTML={{ __html: item }}></li>)}
                                </ul>
                            </div>
                        </div>}
                    {modalData[id].upgrade["list"].length > 0 &&
                        <div className="room-upgrade">
                            <div className="room-upgrade__head">
                                <Headline design="01" hlLevel="p">アップグレートアメニティ</Headline>
                            </div>
                            <div className="room-upgrade__body">
                                {modalData[id].upgrade["desc"] && <p dangerouslySetInnerHTML={{ __html: modalData[id].upgrade["desc"] }}></p>}
                                <ul>
                                    {modalData[id].upgrade["list"].map((item: string, index: number) => <li key={index} dangerouslySetInnerHTML={{ __html: item }}></li>)}
                                </ul>
                            </div>
                        </div>}
                    {modalData[id].balcony["list"].length > 0 &&
                        <div className="room-balcony">
                            <div className="room-balcony__head">
                                <Headline design="01" hlLevel="p">ベランダ</Headline>
                            </div>
                            <div className="room-balcony__body">
                                {modalData[id].balcony["desc"] && <p dangerouslySetInnerHTML={{ __html: modalData[id].balcony["desc"] }}></p>}
                                <ul>
                                    {modalData[id].balcony["list"].map((item: string, index: number) => <li key={index} dangerouslySetInnerHTML={{ __html: item }}></li>)}
                                </ul>
                            </div>
                        </div>}
                    {modalData[id].preDepartureServices["list"].length > 0 &&
                        <div className="room-preDepartureServices">
                            <div className="room-preDepartureServices__head">
                                <Headline design="01" hlLevel="p">出発前サービス​</Headline>
                            </div>
                            <div className="room-preDepartureServices__body">
                                {modalData[id].preDepartureServices["desc"] && <p dangerouslySetInnerHTML={{ __html: modalData[id].preDepartureServices["desc"] }}></p>}
                                <ul>
                                    {modalData[id].preDepartureServices["list"].map((item: string, index: number) => <li key={index} dangerouslySetInnerHTML={{ __html: item }}></li>)}
                                </ul>
                    ...
                    {modalData[id].onboardServices["list"].length > 0 &&
                        <div className="room-onboardServices">
                            <div className="room-onboardServices__head">
                                <Headline design="01" hlLevel="p">船内サービス​​</Headline>
                            </div>
                            <div className="room-onboardServices__body">
                                {modalData[id].onboardServices["desc"] && <p dangerouslySetInnerHTML={{ __html: modalData[id].onboardServices["desc"] }}></p>}
                                <ul>
                                    {modalData[id].onboardServices["list"].map((item: string, index: number) => <li key={index} dangerouslySetInnerHTML={{ __html: item }}></li>)}
                                </ul>
                            </div>
                        </div>}
                    {modalData[id].guest.length > 0 &&
                        <div className="room-guest">
                            <div className="room-guest__head">
                                <Headline design="01" hlLevel="p">コンシェルジュゲスト専用​​</Headline>
                            </div>
                            <div className="room-guest__body">
                                {modalData[id].guest.map((item: string, index: number) => <p key={index} dangerouslySetInnerHTML={{ __html: item }}></p>)}
                            </div>
                        </div>}
                </div>
            </div >
