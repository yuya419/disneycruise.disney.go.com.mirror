...
export function Page() {
  ...
  const navArray = {
    parent01: [
      { item: ['コンシェルジュ スイートと<br class="nosp"/>客室', "sec01"] },
    ],
  ...
  const heroSliderItems = [
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/concierge/hero01.jpg")}
              alt="コンシェルジュルームのイメージ"
              width={1366}
              height={768}
              priority
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/concierge/hero02.jpg")}
              alt="コンシェルジュルームのイメージ"
              width={1366}
              height={768}
              priority
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/concierge/hero03.jpg")}
              alt="コンシェルジュルームのイメージ"
              width={1366}
              height={768}
              priority
          ...
          dom: (
            <dl className="card-item">
              ...
              <dd className="card-item__body">
                <figure>
                  <Image
                    src={getImagePath("page/concierge/img02-slide01.jpg")}
                    alt="ロイヤルスイートのイメージ"
                    width={297}
                    height={170}
                  />
          ...
          dom: (
            <dl className="card-item">
              ...
              <dd className="card-item__body">
                <figure>
                  <Image
                    src={getImagePath("page/concierge/img02-slide02.jpg")}
                    alt="オーシャンビュースイートのイメージ"
                    width={297}
                    height={170}
                  />
                  <figcaption>Artist Concept Only &copy;Disney</figcaption>
          ...
          dom: (
            <dl className="card-item">
              ...
              <dd className="card-item__body">
                <figure>
                  <Image
                    src={getImagePath("page/concierge/img02-slide03.jpg")}
                    alt="ベランダのイメージ"
                    width={297}
                    height={170}
                  />
          ...
          dom: (
            <dl className="card-item">
              ...
              <dd className="card-item__body">
                <figure>
                  <Image
                    src={getImagePath("page/concierge/img02-slide04.jpg")}
                    alt="オーシャンビューのイメージ"
                    width={297}
                    height={170}
                  />
          ...
          dom: (
            <dl className="card-item">
              ...
              <dd className="card-item__body">
                <figure>
                  <Image
                    src={getImagePath("page/concierge/img02-slide05.jpg")}
                    alt="インサイドのイメージ"
                    width={297}
                    height={170}
                  />
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/concierge/img03-slide01.jpg")}
              alt="コンシェルジュラウンジのイメージ"
              width={784}
              height={440}
            />
          ),
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/concierge/img04-slide01.jpg")}
              alt="屋外サンデッキのイメージ"
              width={784}
              height={440}
            />
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/concierge/img05-slide01.jpg")}
              alt="スパスイートのイメージ"
              width={784}
              height={440}
            />
          ...
          <article className="l-article">
            ...
            <section id="sec06" className="p-concierge-section">
              <OnmHeadline01
                hlLevel="h2"
                jp="特別なアメニティ"
                en='Exclusive <br class="nopc" />Amenities'
              />
              <div className="concierge-block">
                <div className="card-list">
                  <dl className="card-item">
                    ...
                    <dd className="card-item__body">
                      <figure>
                        <Image
                          src={getImagePath("page/concierge/img06-card01.jpg")}
                          alt="スパ＆フィットネスエリアのイメージ"
                          width={334}
                          height={196}
                        />
                        <figcaption>
                          Artist Concept Only &copy;Disney
                        </figcaption>
                      </figure>
                      <span className="desc">
                        コンシェルジュスパの自然からインスピレーションを得た静寂のオアシスでリラックスしてリフレッシュしてください。マッサージ、フェイシャル、鍼治療などの贅沢なスパと美容トリートメントをお楽しみください。また、コンシェルジュゲスト専用の設備の整ったエクササイズとヨガの施設がスパに隣接しており、海上でも体調を整えてお過ごしいただけます。
                      </span>
                    </dd>
                  </dl>
                  <dl className="card-item">
                    ...
                    <dd className="card-item__body">
                      <figure>
                        <Image
                          src={getImagePath("page/concierge/img06-card02.jpg")}
                          alt="限定ショッピングのイメージ"
                          width={334}
                          height={196}
                        />
                      ...
                      <span className="desc">
                        船内の豊富なアメニティに加え、コンシェルジュゲストは、高級品、高級ジュエリー、ディズニーのコレクションや商品を取り揃えた特別なショッピング体験もお楽しみいただけます。
                      </span>
                    </dd>
                  </dl>
                  <dl className="card-item">
                    <dt className="card-item__head">
                      ...
                      <span className="en" lang="en">
                        Heightened Level of Personalized Service
                      </span>
                    </dt>
                    <dd className="card-item__body">
                      <figure>
                        <Image
                          src={getImagePath("page/concierge/img06-card03.jpg")}
                          alt="パーソナライズされたサービスのレベルの向上のイメージ"
                          width={334}
                          height={196}
                        />
                        <figcaption>
                      ...
                      <span className="desc">
                        ディズニーならではのホスピタリティを極限まで高めたサービスをご体験ください。専属チームがご旅行前とご旅行中にお手伝いいたします。旅程の作成やご予約の管理から、スイート内でのお食事やお祝いのプランニングまで、専属のコンシェルジュチームが細部まで細心の注意を払って対応いたします。
                      </span>
                    </dd>
                  </dl>
                </div>
