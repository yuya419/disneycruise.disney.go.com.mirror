...
export function Page() {
  ...
  const breadcrumbItems = [{ label: "ダイニング", href: "/dining/" }];
  ...
  const heroSliderItems = [
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/dining/hero01.jpg")}
              alt="ダイニングイメージ"
              width={1366}
              height={768}
              priority
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/dining/hero02.jpg")}
              alt="ダイニングイメージ"
              width={1366}
              height={768}
              priority
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/dining/hero03.jpg")}
              alt="ダイニングイメージ"
              width={1366}
              height={768}
              priority
              ...
              return (
                <dl key={index} className="card-item">
                  <dt className="card-item__head">
                    ...
                    <span
                      className="jp"
                      dangerouslySetInnerHTML={{ __html: card.jp }}
                    ></span>
                    <span
                      className="en"
                      lang="en"
                      dangerouslySetInnerHTML={{ __html: card.en }}
                    ></span>
                  </dt>
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/dining/img01-slide01.jpg")}
              alt="パロ・トラットリアのイメージ"
              width={704}
              height={440}
            />
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/dining/img02-slide01.jpg")}
              alt="マイク＆サリーズのイメージ"
              width={704}
              height={440}
            />
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/dining/img03-slide01.jpg")}
              alt="バッカニアバーのイメージ"
              width={704}
              height={440}
            />
      ...
      dom: (
        <dl className="card-item">
          ...
          <dd className="card-item__body">
            <figure>
              <Image
                src={getImagePath("page/dining/img04-slide01.jpg")}
                alt="グランマタラズキッチン​"
                width={297}
                height={170}
              />
            ...
            <span className="desc">
              ディズニーの映画『モアナ』にインスパイアされたこの場所では、アジアと南太平洋の風味を取り入れた料理を、素早く提供します。​
            </span>
          </dd>
        </dl>
      ),
      ...
      dom: (
        <dl className="card-item">
          ...
          <dd className="card-item__body">
            <figure>
              <Image
                src={getImagePath("page/dining/img04-slide02.jpg")}
                alt="モーグリズイータリー"
                width={297}
                height={170}
              />
            ...
            <span className="desc">
              ディズニーの映画『ジャングル・ブック』にインスパイアされたこのレストランでは、インディアン、ベジタリアン、そして地域特有の料理が楽しめます。​
            </span>
          </dd>
        </dl>
      ),
      ...
      dom: (
        <dl className="card-item">
          ...
          <dd className="card-item__body">
            <figure>
              <Image
                src={getImagePath("page/dining/img04-slide03.jpg")}
                alt="スティッチズオハナグリル​"
                width={297}
                height={170}
              />
            ...
            <span className="desc">
              テイクアウト店。クラシックなアメリカン料理にアイランド風のひねりを加えた料理が楽しめます。​
            </span>
          </dd>
        </dl>
      ),
      ...
      dom: (
        <dl className="card-item">
          ...
          <dd className="card-item__body">
            <figure>
              <Image
                src={getImagePath("page/dining/img04-slide04.jpg")}
                alt="ビウィッチングボバ＆ブリューズ​​"
                width={297}
                height={170}
              />
            ...
            <span className="desc">
              ディズニーのヴィランズにインスパイアされたこのカフェでは、魅力的で少し悪魔的なボバドリンクを楽しむことができます。​
            </span>
          </dd>
        </dl>
      ),
          ...
          <article className="l-article">
            <section id="sec01" className="p-dining-section">
              <OnmHeadline01
                hlLevel="h2"
                jp="ローテーショナル・ダイニング"
                en={`3 Dining <br class="nopc" />Experiences`}
              />
              <div className="dining-block">
                <div className="lead">
                  <p>
                    ゲストの航海中に、ディズニーならではの3つの異なるダイニング体験をお楽しみいただけます。
                    <br />
                    ※指定のレストランをご利用いただきます。
                    <br className="nopc" />
                    お選びいただく事はできません。
            ...
            <section id="sec02" className="p-dining-section">
              <OnmHeadline01
                hlLevel="h2"
                jp="プレミアムダイニング＆ラウンジ"
                en={`Premium Dining <br class="nopc" />& Lounge`}
              />
              <div className="dining-block">
                <div className="area">
            ...
            <section id="sec03" className="p-dining-section">
              <OnmHeadline01
                hlLevel="h2"
                jp="クイックサービスダイニング​"
                en={`Quick Service <br class="nopc" />Dining`}
              />
              <div className="dining-block">
