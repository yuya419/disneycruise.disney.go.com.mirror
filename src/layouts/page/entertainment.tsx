...
export function Page() {
  ...
  const navArray = {
    parent01: [
      { item: ['アベンジャーズ<br class="nosp"/>アッセンブル！​​', "sec01"] },
    ],
    parent02: [{ item: ["ダッフィーとフレンドシップ", "sec02"] }],
    parent03: [
      {
        item: [
          'ジャック・スパロウ船長と<br class="nosp"/>セイレーンの女王',
          "sec03",
        ],
      },
    ],
    ...
    parent05: [
      {
        item: [
          'ディズニーシーズ ザ・<br class="nosp"/>アドベンチャー​',
          "sec05",
        ],
      },
    ],
    ...
    parent07: [
      {
        item: [
          'ベイマックス スーパー<br class="nosp"/>エクササイズエキスポ​​',
          "sec07",
        ],
      },
    ],
  ...
  const heroSliderItems = [
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/entertainment/hero01.jpg")}
              alt="「アベンジャーズアッセンブル！​​」イメージ"
              width={1366}
              height={768}
              priority
            />
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/entertainment/hero02.jpg")}
              alt="「ジャック・スパロウ船長とセイレーンの女王​」イメージ"
              width={1366}
              height={768}
              priority
            />
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/entertainment/hero03.jpg")}
              alt="「ディズニーシーズ ザ・アドベンチャー​​​」イメージ"
              width={1366}
              height={768}
              priority
            />
  ...
  const sectionArray = [
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/entertainment/img01-slide01.jpg")}
              alt="アベンジャーズ アッセンブル！​​のイメージ"
              width={784}
              height={440}
            />
          ),
    ...
    },
    {
      ...
      desc: "愛らしいキャラクターたちと陽気なガイド、ティッピー・ブルーと一緒に、心温まる大海原の冒険に出かけましょう。魅惑的な歌、素晴らしい映像、楽しいひとときとともに、海の魔法、想像力の力、そして友情の本当の意味を学びましょう。<br>ショーの後はキャラクターたちに会い、ダッフィー＆フレンズ・ショップで大切な記念品を手に入れることもできます。ダッフィー＆フレンズ・ディスカバリー・クエストで楽しみを広げ、船内の手がかりをたどって失くしたものを見つけ、特別な賞品を獲得できます。",
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/entertainment/img02-slide01.jpg")}
              alt="ダッフィーとフレンドシップのイメージ"
              width={784}
              height={440}
            />
          ),
    ...
    },
    {
      ...
      en: `Captain Jack Sparrow <br />& the Siren Queen`,
      desc: "帆を上げ、いたずら好きで魅力的なジャック・スパロウ船長とその海賊仲間とともに、邪悪な呪いを解くための冒険に出発します。この冒険ショーでは、ジャック船長が希少な輝く宝を探し求め、LEDスクリーンに映し出されそびえ立つセイレーンの女王と対決します。",
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/entertainment/img03-slide01.jpg")}
              alt="ジャック・スパロウ船長とセイレーンの女王のイメージ"
              width={784}
              height={440}
            />
          ),
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/entertainment/img04-slide01.jpg")}
              alt="リメンバーのイメージ"
              width={784}
              height={440}
            />
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/entertainment/img05-slide01.jpg")}
              alt="ディズニーシーズ ザ・アドベンチャー​のイメージ"
              width={784}
              height={440}
            />
          ),
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/entertainment/img06-slide01.jpg")}
              alt="モアナ：コールトゥザシー​のイメージ"
              width={784}
              height={440}
            />
          ),
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/entertainment/img07-slide01.jpg")}
              alt="ベイマックス スーパーエクササイズエキスポ​​のイメージ"
              width={784}
              height={440}
            />
          ),
              ...
              <div className="message">
                ...
                <div className="message-box">
                  ...
                  <div className="message__detail">
                    <p>
                      華やかなブロードウェイスタイルのショー、楽しいデッキパーティー、映画上映、
                      <br className="nosp" />
                      ディズニー、ピクサー、マーベルのお気に入りの仲間たちとの忘れられない交流会など、
                      <br className="nosp" />
                      ディズニーの魔法を体験してください。
                    </p>
                  </div>
