...
export function Page() {
  const breadcrumbItems = [{ label: "よくあるご質問", href: "/qa/" }];
          ...
          <article className="l-article">
                ...
                <AccordionType02
                  ...
                  content={
                    <div className="qa-content">
                      <p>
                        クルーズにご参加の場合は、下船日から数えて6カ月以上有効期限が必要です。
                        <br />
                        パークのみご参加の場合はアメリカ入国時90日以上の有効期限が望ましいとされています。
                      </p>
                    </div>
                  }
                />
            ...
            <section id="sec03" className="p-qa-section">
              ...
              <div className="qa-block">
                <AccordionType02
                  label={Qlabel(
                    "キャラクターグリーティングを行っているレストランはありますか？",
                  )}
                  content={
                    <div className="qa-content">
                      <p>
