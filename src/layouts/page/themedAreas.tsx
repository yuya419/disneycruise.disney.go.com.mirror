...
export function Page() {
  ...
  const navArray = {
    ...
    parent03: [
      {
        item: ["7つのテーマエリア", "sec03"],
        child: [
          {
            item: [
              'ディズニー<br class="nosp"/>イマジネーションガーデン',
              "area01",
            ],
          },
          {
            item: [
              'ディズニー<br class="nosp"/>ディスカバリーリーフ',
              "area02",
            ],
          },
          ...
          {
            item: [
              'サンフランソウキョウ・<br class="nosp"/>ストリート',
              "area06",
            ],
          },
  ...
  const heroSliderItems = [
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/themed-areas/area01/hero.jpg")}
              alt="ディズニーイマジネーションガーデン"
              width={1366}
              height={768}
              priority
            />
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/themed-areas/area02/hero.jpg")}
              alt="ディズニーディスカバリーリーフ"
              width={1366}
              height={768}
              priority
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/themed-areas/area03/hero.jpg")}
              alt="トイストーリープレイス​"
              width={1366}
              height={768}
              priority
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/themed-areas/area04/hero.jpg")}
              alt="マーベルランディング​​"
              width={1366}
              height={768}
              priority
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/themed-areas/area05/hero.jpg")}
              alt="ウェイファインダーベイ​"
              width={1366}
              height={768}
              priority
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/themed-areas/area06/hero.jpg")}
              alt="サンフランソウキョウ・ストリート"
              width={1366}
              height={768}
              priority
            />
    ...
    },
    {
      dom: (
        <>
          <figure>
            <Image
              src={getImagePath("page/themed-areas/area07/hero.jpg")}
              alt="タウン・スクエア"
              width={1366}
              height={768}
              priority
  ...
  const areaArray = [
    {
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/themed-areas/area01/slide01.jpg")}
              alt="ディズニーイマジネーションガーデンのイメージ"
              width={704}
              height={440}
            />
          ),
      ...
      caption:
        "Artist Concept Only &copy;Disney &copy;Disney/Pixar &copy;2024 MARVEL",
    },
    {
      id: "area02",
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/themed-areas/area02/slide01.jpg")}
              alt="ディズニーディスカバリーリーフのイメージ"
              width={704}
              height={440}
            />
          ),
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/themed-areas/area03/slide01.jpg")}
              alt="トイストーリープレイス​のイメージ"
              width={704}
              height={440}
            />
          ),
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/themed-areas/area04/slide01.jpg")}
              alt="マーベルランディング​​のイメージ"
              width={704}
              height={440}
            />
          ),
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/themed-areas/area05/slide01.jpg")}
              alt="ウェイファインダーベイ​のイメージ"
              width={704}
              height={440}
            />
          ),
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/themed-areas/area06/slide01.jpg")}
              alt="サンフランソウキョウ・ストリートのイメージ"
              width={704}
              height={440}
            />
          ),
      ...
      slides: [
        {
          dom: (
            <Image
              src={getImagePath("page/themed-areas/area07/slide01.jpg")}
              alt="タウン・スクエアのイメージ"
              width={704}
              height={440}
            />
  ...
  return (
    <div className="p-themed-areas">
      ...
      <Title
        type="slider"
        title="7つのテーマエリア・客船紹介"
        en="<span>7</span>Themed Areas"
          ...
          <article className="l-article">
            <section id="sec01" className="p-themed-areas-section">
              ...
              <div className="themed-areas-block">
                <Headline design="01" hlLevel="h3">
                  ディズニー・アドベンチャー​
                </Headline>
                <div className="img">
                  <Image
                    src={getImagePath("page/themed-areas/img01.jpg")}
                    alt="ディズニー・アドベンチャー​イメージ"
                    width={784}
                    height={407}
                  />
                </div>
            ...
            <Deckplan id="sec02" />
            <section id="sec03" className="p-themed-areas-section">
              <OnmHeadline01
                hlLevel="h2"
                jp="7つのテーマエリア"
                en="7 Themed Areas"
              ...
              <div className="themed-areas-block">
                <div className="lead">
                  <p>
                    船内の想像力豊かなテーマの7つのエリアを探索しながら、魔法のような冒険に出発します。
                    <br />
                    各エリアには、ディズニー、マーベル、ピクサーの物語を壮大なスケールで再現した
                    <br className="nosp" />
                    没入感あふれる体験が満載です。
                  </p>
                </div>
