  ...
  const EntryContent = () => {
    return (
      <div className="entry-body">
        <BlockImg
          src={"/ships/adventure/common/dummy/content/dummy01.jpg"}
          alt={"ダミー"}
          width={824}
          height={493}
        />
        <BlockHeadline hlLevel="h2">
          2025年、ディズニー・クルーズラインがシンガポールにやってきます(h2)
        </BlockHeadline>
        <BlockImg
          src={"/ships/adventure/common/dummy/content/dummy02.jpg"}
          alt={"ダミー"}
          width={824}
          height={443}
        />
        <p>
          壮大なスケールの魅惑的なクルージングバケーションを体験してみませんか。
        </p>
        <p>
        ...
        <BlockTwoCol
          left={
            <BlockImg
              src={"/ships/adventure/common/dummy/content/dummy03.jpg"}
              alt={"ダミー"}
              width={392}
              height={243}
              caption="キャプション"
          ...
          right={
            <BlockImg
              src={"/ships/adventure/common/dummy/content/dummy04.jpg"}
              alt={"ダミー"}
              width={392}
              height={243}
              caption="トイストーリープレイス​"
        ...
        />
        <BlockHeadline hlLevel="h3">
          最高の快適さと利便性を追求した客室で、旅を満喫。(h3)
        </BlockHeadline>
        <p>
          楽しい家族旅行、友人との小旅行、カップルでの小旅行など、ディズニーの客室とスイートなら、リラックスして快適にお過ごしいただけます。
          <br />
          各客室とスイートには、<a href="#">ディズニー</a>、
          <a href="#">ピクサー</a>、<a href="#">マーベル</a>
          のストーリーにインスピレーションを得たアートワークなど、他では見られない魔法のような雰囲気が漂います。
        </p>
        <BlockHeadline hlLevel="h4">
          夢と魔法がいっぱいの冒険をはじめましょう。(h4)
        </BlockHeadline>
        <BlockSlider
          images={[
        ...
        />
        <BlockHeadline hlLevel="h2">
          船上で味わう、最高のエンターテイメント(h2)
        </BlockHeadline>
        <BlockMovie type="video" src="/ships/adventure/movie/dcl_da_pc.mp4" />
        <p>
          楽しい家族旅行、友人との小旅行、カップルでの小旅行など、ディズニーの客室とスイートなら、リラックスして快適にお過ごしいただけます。
          <br />
          各客室とスイートには、テキストリンクのストーリーにインスピレーションを得たアートワークなど、他では見られない魔法のような雰囲気が漂います。
        </p>
        <BlockButton href="/">予約はこちら（ボタン要素）</BlockButton>
        <BlockImg
          src={"/ships/adventure/common/dummy/content/dummy06.jpg"}
          alt={"ダミー"}
          width={824}
          height={355}
        />
        ...
        />
        <BlockTable
          header={[{ "1": { text: "表組2列" }, "2": { text: "表組2列" } }]}
          body={[
            {
              "1": { text: "出発日の前日から起算して90日以上前" },
              "2": { text: "無料" },
