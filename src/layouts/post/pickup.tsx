...
export function Pickup(props: {
    ...
    const [emblaRef, emblaApi] = useEmblaCarousel({ loop: true, align: "center" }, [ClassNames(), autoplay.current]);
    ...
    const postItems = Object.keys(posts).map((key) => {
        return (
            <article className="post-item" key={key}>
                <Link href={'/' + props.type + '/' + posts[key].link} className="post-link uline">
                    <div className="post-content">
                        ...
                        <div className="meta">
                            <h2 className="title"><span className="clamp"><span className="line">{posts[key].title}</span></span></h2>
    ...
    return (
        <div className="post-pickup" data-type={type}>
            <div className="post-pickup__head">
                ...
                <h2 className="label" lang="en">PICK UP</h2>
