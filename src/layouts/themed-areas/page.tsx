...
export function Page() {
    ...
    const heroSliderItems = [
        {
            dom: <><figure>
                <Image src={getImagePath("page/themed-areas/area01/hero.jpg")} alt="ディズニーイマジネーションガーデン" width={1366} height={768} />
                <figcaption>Artist Concept Only<br />&copy;Disney &copy;Disney/Pixar<br />&copy;2024 MARVEL</figcaption>
            </figure></>
        },
        {
            dom: <><figure>
                <Image src={getImagePath("page/themed-areas/area02/hero.jpg")} alt="ディズニーディスカバリーリーフ" width={1366} height={768} />
                <figcaption>Artist Concept Only<br />&copy;Disney &copy;Disney/Pixar</figcaption>
            </figure></>
        },
        {
            dom: <><figure>
                <Image src={getImagePath("page/themed-areas/area03/hero.jpg")} alt="トイストーリープレイス​" width={1366} height={768} />
                <figcaption>Artist Concept Only<br />&copy;Disney &copy;Disney/Pixar</figcaption>
            </figure></>
        },
        {
            dom: <><figure>
                <Image src={getImagePath("page/themed-areas/area04/hero.jpg")} alt="マーベルランディング​​" width={1366} height={768} />
                <figcaption>Artist Concept Only<br />&copy;Disney &copy;2024 MARVEL</figcaption>
            </figure></>
        },
        {
            dom: <><figure>
                <Image src={getImagePath("page/themed-areas/area05/hero.jpg")} alt="ウェイファインダーベイ​" width={1366} height={768} />
                <figcaption>Artist Concept Only<br />&copy;Disney</figcaption>
            </figure></>
        },
        {
            dom: <><figure>
                <Image src={getImagePath("page/themed-areas/area06/hero.jpg")} alt="サンフランソウキョウ・ストリート" width={1366} height={768} />
                <figcaption>Artist Concept Only<br />&copy;Disney</figcaption>
            </figure></>
        },
        {
            dom: <><figure>
                <Image src={getImagePath("page/themed-areas/area07/hero.jpg")} alt="タウン・スクエア" width={1366} height={768} />
                <figcaption>Artist Concept Only<br />&copy;Disney &copy;Disney/Pixar</figcaption>
            </figure></>
        }
    ]
