        ...
        <section className="t-entertainment">
            ...
            <div className="container">
                <hgroup className="t-entertainment__head">
                    ...
                    <h2 lang="en">Legendary <br className="nopc" />Entertainment</h2>
                </hgroup>
                <div className="t-entertainment__detail">
                    <div className="detail">
                        ...
                        <div className="text-box">
                            <h3>きっとあなたは、<br />忘れられない魔法にかかる。</h3>
                            <p>華やかなブロードウェイ<br className="nopc" />スタイルのショー、<br />
                                楽しいデッキパーティー、映画上映。<br />
                                ディズニー、ピクサー、<br />
                                マーベルのお気に入りの仲間たちとの<br />
                                忘れられない交流会など、<br />
                                ディズニーの魔法を体験してください。</p>
                            <Button type="primary" label="View More" lang="en" link="/entertainment/" align="center" />
                        </div>
                    ...
                    <p className="en" lang="en">The magic of Disney for all guests.</p>
                </div>
            </div>
